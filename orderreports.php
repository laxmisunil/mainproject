...
include "connection.php";
   ...
   $query7 = "select count(*) as totalshipped from tbl_order where orderStatus='2'";
   ...
   if(mysqli_num_rows($result)){
      ...
      $count7 = $row['totalshipped'];
   }

   $query8 = "select count(*) as totaldelivered from tbl_order where orderstatus=3";
   ...
   if(mysqli_num_rows($result)){
      ...
      $count8 = $row['totaldelivered'];
   }

   $query9 = "select count(*) as totalcancel from tbl_order where orderStatus=0";
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<br>
					<button onclick="window.location.href='adminrevpre.php'" id="viewdata3">Show Revenue Info</button>
					<ul class="breadcrumb">
						<!--<li>
							<a href="#">Dashboard</a>
						</li>
