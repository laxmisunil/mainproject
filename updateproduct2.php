...
    topicSel.length = 1;
  ...
  <a href="productlist.php" id="active">Products</a><br>
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
                    ...
                    <fieldset style="margin-top: 2cm;margin-left: 6cm;margin-right: 11cm;background-color:white;padding-bottom: 0.2cm;">
                <form action="productupdation.php?productID=<?php echo $productid ?>" method="POST" target="_self" enctype="multipart/form-data">
                   
                    <br>

                    <input type="text"  id="procategory"  size="30cm" pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" value="<?php echo $productcategory ?>" name="procategory" required readonly><br>
                    <input type="text"  id="prosubcategory"  size="30cm" pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" value="<?php echo $productsubcategory ?>" name="prosubcategory" required readonly><br>
                    <input type="text"  id="proname"  size="30cm" pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" value="<?php echo $productname ?>"  placeholder="Product Name" name="proname" required readonly><br>
                    <input type="text"  id="prosubname"  size="30cm" pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" value="<?php echo $productsubname ?>" placeholder="Product Subname" name="prosubname" required readonly><br>
                    <input type="number" min=1 placeholder="New Product Price (Rs.)" size="30cm" value="<?php echo $productprice ?>"name="productprice" id="proprice" required><br>
                    <textarea pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" rows="2" cols="60cm" onfocusout="check()" maxlength=100 name="productdescription" id="productdescription" placeholder="  Product Description" required><?php echo $productdescription ?></textarea><br><br>
                    <div id="response2" style="font-size:small;text-align:left"></div>

                    <label for="proimage" >Add Product Image</label>
                    <input type="file"  name="newproductimage" value="" id="proimage" accept="image/*"><br>
