...
<div id="div2">
        <fieldset style="width:50%;border:2px solid black;">
            ...
            <form action="missingadded.php?userID=<?php echo $userID ?>" method="POST" id="form" style="background-color:white" enctype="multipart/form-data">
            <br>
                ...
                <select name="species" id="species" style="width:37%;margin-left:0.2cm;margin-right:0cm;" required>
                <option value="" disabled selected hidden>--Select Species--</option> 
                </select>

                <select name="breed" id="breed" style="width:40%;margin-left:0.2cm;margin-right:0.2cm" required>
               ...
               <br>
                ...
                <select name="animalcolor" id="color" style="width:80%" required>
                <option value="" disabled selected hidden>--Pet Complexion--</option>
                ...
                <label for="animalimage"><font size="3px">Add Image</font></label><br>

               
                <input type="file" name="animalimage" id="image" 
                size="30cm" style="margin-left:0.2cm;background-color:white"><br>

                <input type="email" onkeyup="ValidateEmail();" name="email" id="email" placeholder="E-mail ID" size="30cm" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required><br>
                   
                    <div ><span id="lblError" style="color: red;font-size:small"></span></div>
                    
                    
                   
                    <input type="tel" name="phone" id="phone" onkeyup="ValidatePhone();" placeholder="Enter your Mobile No."  size="30cm" minlength="10" maxlength="10" required><br> 
