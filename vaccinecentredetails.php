...
<div class="sidenav">
  ...
  <a href="" id="active">Vaccination</a><br>
		...
		<main>
			...
			<div class="table-data">
				<div class="order">
                    ...
                    <?php
                     $query9 = "select count(*) as totalvaccines from tbl_vaccinedetails where vaccineStatus=1";
                     ...
                     if(mysqli_num_rows($result)){
                        ...
                        $count9 = $row['totalvaccines'];
                     }

                    ?>
                    <?php
include "connection.php";
$sel="SELECT * FROM tbl_userdetails WHERE userRole='VaccineCentre'";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
        ...
        ?>
            ...
            <td><?php echo $row["userPhone"] ?>&nbsp;<a style="color:black;text-align:center" title="Edit name" href="updatevaccinecentre.php"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
            ...
            <td>
                 ...
                 <form id="form" action="changevaccinecentrestatus.php?userID=<?php echo $row["userID"] ?>" method="POST">
                 <label class="switch" >
        ...
        ?>
			...
			<br>
				...
				<form method="post" action="pdftodownload14.php">  
					<input type="submit" name="create_pdf" class="btn btn-danger" id="viewdata2" value="Vaccine List" />  
				</form>&nbsp;

				<form method="post" action="pdftodownload12.php">  
					<input type="submit" name="create_pdf" class="btn btn-danger" id="viewdata3" value="Vaccination Report" />  
				</form>
				</div>
