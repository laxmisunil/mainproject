            ...
            if($result2=$conn->query($selproduct))
            {
                if($result2->num_rows>0)
                {
                    while($row=$result2->fetch_array())
                    {
                        ...
                        <td><a href="myorders_onview.php?orderid=<?php echo $orderID; ?>" style="text-decoration:none;color:blue">View Products</a></td>
                       
                        <?php if($orderstatus==1)
                        {?>

        
                        <td><a href="cancelorder.php?orderid=<?php echo $orderID; ?>" style="text-decoration:none;color:red" title="Cancel Order" onclick="return confirm('Are you sure you want to cancel this order?');">CANCEL ORDER</a></td>
                        ...
                        {
                        ?>
                        <td style="color:gray">Receipt Unavailable</td>
                        <?php }
                        ?>
                        </td>
                        </tr>
