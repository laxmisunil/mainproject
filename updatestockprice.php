...
<section id="content" style="font-size:24px">
		...
		<main>
                    ...
                    <fieldset style="margin-left: 8cm;margin-right: 8cm;background-color:white;padding: 10px;"><br>
                    <center><h3>Update Stock</h3></center><br>
                    <form action="stockupdated.php?stockID=<?php echo $stockID; ?>" method="POST" target="_self" enctype="multipart/form-data">
                    
                    <span style="font-size:15px"><?php echo $productquantity.$productmeasure; ?></span>
                    <span style="font-size:15px"><?php echo "currently in stock : ".$productstock; ?></span>
                    
            
                    <input type="number" id="productsinstock" min="1" size="30cm" pattern="^[0-9]*$" title="Must contain digits only" name="newstock" required><br>
...
{
    $newstock=$_POST["productsinstock"];
    $new=$productstock+$newstock;
    $updatestock="UPDATE tbl_stock SET productStock=$new WHERE stockID='$stockID'";
try
{
    if($conn->query($updatestock)===true);
    //header("location:productweight.php?status2=2");
