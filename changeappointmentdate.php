...
$sel3="SELECT tbl1.*,tbl2.* FROM tbl_appointmentdetails AS tbl1 INNER JOIN tbl_pet AS tbl2 ON tbl1.petID=tbl2.petID WHERE tbl1.appointmentID='$appointmentID' AND tbl1.customerID='$userID'";
if($result3=$conn->query($sel3))
{
    if($result3->num_rows>0)
    {
        ...
        <div id="div2" style="background-image: url('dogcat4.png');background-repeat:no-repeat">
            ...
            <form action="appointmentdateupdated.php?appointmentID=<?php echo $appointmentID ?>"  target="_self" method="POST">

            
                
           <input type="text" id="savedinfo1" value="<?php echo $petname ?>" readonly>

   
        
                <input type="date"  id="datepick" name="date" size="30cm" min="2022-12-24" max="2023-02-24" onfocus="checklimit()" required><br>
                ...
                <input type="text" id="savedinfo2"  value="<?php echo $concern ?>" readonly>
                <input type="submit" name="booknow" value="Save" id="subbutton">      
            </form>   
            <script>
