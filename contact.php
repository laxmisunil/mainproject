...
$sel="SELECT userName,userEmail,userPhone FROM tbl_userdetails WHERE userID='$userID'";
...
#search-speech:hover
{
    cursor: pointer;
        ...
        {
            var cusdistrict = document.getElementById("cusfeedback").value;
...
window.addEventListener("DOMContentLoaded", voice.init);
    ...
    <body>
        ...
        <div class="navigation">
            ...
            <a href="" id="active" class="item">Feedback</a>
        </div>
...
<center>
        <div id="div2" style="background-image: url('dogcat4.png');">
            ...
            <form action="customerfeedback.php" method="POST">
                <input type="text" name="cusname" value="<?php echo $username;?>"placeholder="Enter your name" size="30cm" readonly>
                <input type="text" name="cusemail" value="<?php echo $useremail;?>"placeholder="E-mail ID" size="30cm" readonly><br>
                <div><textarea placeholder="Type your feedback/message here..." onkeyup="ValidateFeedback();" name="cusfeedback" id="cusfeedback" size="30cm" rows="8" cols="30" required></textarea><br> 
                <span id="lblError8" style="color: red;font-size:small"></span></div>
                <input type="submit" value="Submit" name="submitfeedback" id="submitbutton">      
            </form>   
        </div>  
