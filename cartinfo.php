...
#next
{
    ...
    <hr>
    <?php
    $sql = "SELECT sum(productQuantity) FROM tbl_cart WHERE cartStatus=1";
    ...
    <h1 style="margin-left:15.3cm">My Cart</h1>
        
        <div class="dropdown">
        <img src="usericon3.png" class="dropbtn" width="26px" height="26px" style="margin-top:17px;margin-left:11cm;margin-right:2px">
        <?php 
        if($_SESSION["loginStatus"]==3)
        {?>
   ...
   <div style="display:flex"><center>
    <table>
        ...
        <tr>   
            ...
            <td style="text-align:center;width:9%"><abbr title="Remove from cart"><a href="removefromcart.php?cartid=<?php echo $row["cartID"]?>"><img src="removefromcart.png" style="width:50%"></a></abbr></td>
        </tr> 
...
?> 
   ...
   <!--<br><a href="cartinfo.php" style="text-decoration:none;color:blue">View my cart info</a>-->
