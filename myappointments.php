...
$date=date('Y-m-d');?>
    ...
    <?php
$sel="SELECT tbl2.*,tbl1.* FROM tbl_appointmentdetails AS tbl2 INNER JOIN tbl_pet AS tbl1 ON tbl2.petID=tbl1.petID AND tbl2.customerID=tbl1.customerID WHERE consultationDate='$date' AND tbl1.petStatus=1 AND tbl2.appointmentStatus=0";
...
<tr id="tr1">
    ...
    <?php } else?>
        ...
        <?php $_SESSION["appID"]=$row["appointmentID"]?>
            ...
            $todaytime=date('H');
           ?>
            <td><a href="https://meet.google.com/rqn-rbnp-eoa" id="generateID" style="text-decoration:none">JOIN</a></td>
            <!--<td><a href="cancelappointment.php?appointmentID=<?php // echo $row["appointmentID"]; ?>" id="generateID3" style="text-decoration:none;color:Navy;"><i class="fa fa-times" aria-hidden="true"></i>CANCEL </a></td>-->
            <td></td>
