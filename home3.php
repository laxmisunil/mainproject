...
<html>
    ...
    <div class="div45" style="background-color:white">
        <?php
        $i=0;
        while($row=$result->fetch_array())
                {          
                    ...
                    ?>
                    <div class="d1" style="background-color:white;width:20%"><?php
                    echo $i;
                    
                    $image=$row["productImage"];
                    echo "<img src='$image' width='70%' height='auto'> "?>
                    <h3><?php echo $row["productName"] ?></h3>
                    <?php $_SESSION["productname"]=$row["productName"]; ?>
                    <h3 class="price"><?php echo "Rs.".$row["productPrice"] ?></h2>
                    <h4><?php echo $row["productDescription"] ?></h4>
