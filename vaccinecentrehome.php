...
<section id="content" style="font-size:24px">
		...
		<nav>
			...
			<!--<a href="#" class="notification">-->
				...
				<button onclick="header('location:vaccinecentrehome.php');" id="showupcoming3"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>&nbsp;
...
include "connection.php";
$date=date('Y-m-d');
$sel="SELECT tbl2.*,tbl1.*,tbl3.* FROM tbl_vaccinebooked AS tbl2 INNER JOIN tbl_pet AS tbl1 ON tbl2.petID=tbl1.petID INNER JOIN tbl_userdetails AS tbl3 ON tbl3.userID=tbl1.customerID WHERE tbl2.vaccineDate='$date' AND tbl2.vaccinebookedStatus=0 AND tbl1.petStatus!=2";
...
include "connection.php";
$date=date('Y-m-d');
$sel="SELECT tbl2.*,tbl1.*,tbl3.* FROM tbl_vaccinebooked AS tbl2 INNER JOIN tbl_pet AS tbl1 ON tbl2.petID=tbl1.petID INNER JOIN tbl_userdetails AS tbl3 ON tbl3.userID=tbl1.customerID WHERE tbl2.vaccineDate>'$date' AND tbl2.vaccinebookedStatus!=3 AND tbl1.petStatus!=2";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
include "connection.php";
$date=date('Y-m-d');
$sel="SELECT tbl2.*,tbl1.*,tbl3.* FROM tbl_vaccinebooked AS tbl2 INNER JOIN tbl_pet AS tbl1 ON tbl2.petID=tbl1.petID INNER JOIN tbl_userdetails AS tbl3 ON tbl3.userID=tbl1.customerID WHERE tbl2.vaccineDate<'$date' AND tbl2.vaccinebookedStatus=0 OR tbl2.vaccinebookedStatus=2";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
