...
<div class="sidenav">
  ...
  <a style="color:white" href="">Pets</a><br>
...
include "connection.php";
   ...
   $query4 = "select count(*) as totalpets from tbl_pet where petStatus=1";
...
<section id="content" style="font-size:24px">
    ...
    <button onclick="window.history.back();" id="showupcoming3"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>&nbsp;
		...
		<main>
          ...
          <form method="post" action="pdftodownload9.php">  
							  <input type="submit" name="create_pdf" class="btn btn-danger" id="viewdata2" value="Download registered pets" />  
							</form>
					<ul class="breadcrumb">
						<!--<li>
							<a href="#">Dashboard</a>
			...
			<div class="table-data">
				...
				<div class="form-input">
                    ...
                    <?php
include "connection.php";
$sel="SELECT tbl1.*,tbl2.* FROM tbl_pet AS tbl1 INNER JOIN tbl_userdetails AS tbl2 ON tbl1.customerID=tbl2.userID WHERE tbl1.petStatus=1 AND tbl2.userStatus=1 ORDER BY tbl1.petID DESC";
    ...
    if($result->num_rows>0)
    {
        ...
        ?>-->
                ...
                ?>
						<tbody>
							<tr>
                                ...
                                <td>
								<div class="wrapper">
    								<a href="#demo-modal<?php echo $petID?>" style="border:2px solid black;border-radius:4px;background-color:#060714;color:white;padding:4px;">View more</a>
								</div>
								<!--MODAL STARTS...-->

								<div id="demo-modal<?php echo $petID?>" class="modal">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["petColor"];  ?></td>
														...
														<tr>
                                                            ...
                                                            <?php
                                                            if( $row["userHousename"]=="")
                                                            {
                                                            ?>
                                                                <td><font color="grey"><?php echo "(Address not given)"?></font></td>
                                                            <?php
                                                            }
                                                            else
                                                            {
 			...
 			?>	
                                ...
                                <td>
                                <form method="post" action="pdftodownload6.php?petID=<?php echo $petID?>">  
							  <input type="submit" name="create_pdf" class="btn btn-danger" id="viewdata2" value="Download Details" />  
							</form>
