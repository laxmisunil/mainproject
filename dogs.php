...
window.addEventListener("DOMContentLoaded", voice.init);
    ...
    <form action="searchdogproducts.php"  class="live-search-box" id="search-form" method="POST">
        <input type="button" id="search-speech" value="S" title="start recording" style="margin-left:0.67cm;background-color:transparent;border:transparent;color:transparent;padding:4px 10px 4px 4px;" disabled/>
            <input id="s" type="search" name="search" placeholder="Search dog products...">
        ...
        <div class="navigation">
            ...
            <a href="" id="active" class="item">Dogs</a>
    ...
    <div style="display: flex;">
        <center><br>
        <img src="search-breed.png" width="100%">
    </div>
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Food' and (productSubcategory='Dry Food' OR productSubcategory='Wet Food')";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Food' AND (tbl1.productSubcategory='Dry Food' OR tbl1.productSubcategory='Wet Food') GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
        ...
        //counter is zero then we are start new row  
            ...
            echo '<td>'."<div style='text-align:center' class='d1'><form  method='POST' action='addtocartdogs.php?productid=$productID'><img src='$image' width='80%' height='auto'><br>
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Food' AND (productSubcategory='Treats' OR productSubcategory='Chews')";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Food' AND (tbl1.productSubcategory='Treats' OR tbl1.productSubcategory='Chews') GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Food' AND (productSubcategory='Biscuits' OR productSubcategory='Cookies')";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Food' AND (tbl1.productSubcategory='Biscuits' OR tbl1.productSubcategory='Cookies') GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Toys' AND productSubcategory='Chew Toy'";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Toys' AND tbl1.productSubcategory='Chew Toy' GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Toys' AND productSubcategory='Plush Toy'";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Toys' AND tbl1.productSubcategory='Plush Toy' GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Toys' AND productSubcategory='Rope Toy'";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Toys' AND tbl1.productSubcategory='Rope Toy' GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Toys' AND productSubcategory='Soft Toy'";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Toys' AND tbl1.productSubcategory='Soft Toy' GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Accessories' AND productSubcategory='Cloth'";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Accessories' AND tbl1.productSubcategory='Cloth' GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Accessories' AND (productSubcategory='Bowl' OR productSubcategory='Feeder')";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Accessories' AND (tbl1.productSubcategory='Bowl' OR tbl1.productSubcategory='Feeder') GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Accessories' AND (productSubcategory='Collar' OR productSubcategory='Harness')";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Accessories' AND (tbl1.productSubcategory='Collar' OR tbl1.productSubcategory='Harness') GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Accessories' AND (productSubcategory='Bed' OR productSubcategory='Travel Supplies')";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Accessories' AND (tbl1.productSubcategory='Bed' OR tbl1.productSubcategory='Travel Supplies') GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
...
<div class="div2"><center>
  ...
  <?php 
include "connection.php";
//$sel="SELECT * FROM tbl_productdetails WHERE productStatus=1 AND productFor='Dogs' AND productCategory='Accessories' AND productSubcategory='Supplements'";
//first, i set a counter 
$sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productFor='Dogs' AND tbl1.productCategory='Accessories' AND tbl1.productSubcategory='Supplements' GROUP BY tbl2.productID";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
