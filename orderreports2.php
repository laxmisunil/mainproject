...
include "connection.php";
$sel="SELECT tbl1.*,tbl2.orderID,count(tbl2.orderDate) as cntOrder,tbl2.orderDate,tbl3.* FROM tbl_userdetails AS tbl1 INNER JOIN tbl_order AS tbl2 ON tbl1.userID=tbl2.customerID INNER JOIN tbl_orderitems AS tbl3 ON tbl3.order_ID=tbl2.orderID GROUP BY tbl2.orderDate ORDER BY tbl2.orderDate DESC";
                ...
                ?>
						<tbody>
							<tr>
                                ...
                                <?php $orderdate=$row["orderDate"]; ?>
								<td>  <?php echo $row["cntOrder"]; ?></td>
