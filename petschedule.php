...
<script>
    ...
    <a href="adminlogout.php">Logout</a>
        ...
        <body>
            <center>
            <div id="div2">
            <h2 style="font-size:35px">Add Pet Health Schedule</h2>
  
        <form action="addpetschedule.php" target="_self" method="POST">
...
-->
                  ...
                  <input type="text" name="scheduletitle"  pattern="^[a-zA-Z ]*$" title="Alphabets only" id="scheduletitle" onkeyup="check()" onfocusout="ValidateSchedule()" placeholder="Schedule Title" required><br>
                  ...
                  <textarea placeholder="Schedule Description" id="concern" onkeyup="ValidateConcern();" style="text-transform:capitalize" name="scheduledescription" size="30cm" rows="5" cols="34" title="Must contain alphabets only"></textarea><br> 
                 
                  <input type="submit" name="booknow" value="Save" id="submitbutton">      
                </form>
            </div>  
