...
include "connection.php";
   ...
   $query9 = "select count(*) as totalfeedbacks from tbl_feedback where feedbackStatus=1";
    ...
    <button onclick="window.history.back();" id="showupcoming3"><i class="fa fa-arrow-left" aria-hidden="true"></i></button>&nbsp;
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h2>Feedbacks</h2>
          <button id="viewdata2" onclick="window.location.href='adminsen.php'">Analyze Feedbacks</button><br><br>
          <!--<form method="post" action="pdftodownload5.php">  
							  <input type="submit" name="create_pdf" class="btn btn-danger" id="viewdata" value="Download Report" />  
							</form>-->
			...
			<div class="table-data">
				...
				<div class="form-input">
                    ...
                    <?php
include "connection.php";
$sel="SELECT tbl2.*,tbl1.* FROM tbl_feedback AS tbl2 INNER JOIN tbl_userdetails AS tbl1 ON tbl2.customerID=tbl1.userID WHERE feedbackStatus=1  ORDER BY feedbackID DESC";
    ...
    if($result->num_rows>0)
    {
        ...
        ?>
              ...
              <td><?php echo $i ?></td>
                    ...
                    <td style="text-align:left"><a style="color:#D22B2B;text-align:center" title="Delete Feedback" href="removefeedback.php?feedbackid=<?php echo $row["feedbackID"]?>" onclick="return confirm('Are you sure you want to delete this feedback?');"><i class="fa fa-trash" aria-hidden="true"></a></i></td> 
							</tr>
