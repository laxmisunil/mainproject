...
<section id="content" style="font-size:24px">
		...
		<main>
                    ...
                    <center><h3>Update Price</h3></center><br>
                    <form action="priceupdated.php?stockID=<?php echo $stockID; ?>" method="POST" target="_self" enctype="multipart/form-data">
                    
                    <span style="font-size:15px"><?php echo $productquantity.$productmeasure; ?></span>
                    <span style="font-size:15px"><?php echo "current price : ₹ ".$productprice; ?></span>
                    
            
                    <input type="number" id="productsinstock" min="1" size="30cm" pattern="^[0-9]*$" title="Must contain digits only" name="newprice" required><br>
