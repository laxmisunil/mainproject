...
$date=date('Y-m-d');?>
    ...
    <?php
$sel="SELECT tbl1.*,tbl2.* FROM tbl_vaccinebooked AS tbl2 INNER JOIN tbl_pet AS tbl1 ON tbl1.petID=tbl2.petID WHERE tbl1.customerID='$userID' AND tbl2.vaccineDate='$date' AND tbl1.petStatus!=2 AND tbl2.vaccinebookedStatus=0";
if ($result=$conn->query($sel))
{?>
    <div class="div2" >
    <center><h4>Today's Vaccinations</h4></center>
</div>
<div style="display:flex">
&nbsp;
...
<button onclick="window.location.href=''"id="showupcoming" style="background-color:Silver;color:black">Today's Vaccination</button>
