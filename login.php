...
try
{
    ...
    <div id="snackbar">Account Created! Please Login to Continue</div>
...
catch(Exception)
{
    ...
    <div id="snackbar2">Email ID/Phone already registered</div>
        ...
        <div>  
            <fieldset style="margin-top: 2cm;margin-left: 11cm;margin-right: 11cm;background-color:white;padding-bottom: 0.2cm;">
                <form action="test1.php" method="POST" target="_self">
                    ...
                    <div class="g-recaptcha" data-sitekey="6LcNqtUjAAAAAHZG-QPaQzMUgy6yXwP-rPf3xngc"> </div>
