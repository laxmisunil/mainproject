...
$username="SELECT * FROM tbl_appointmentdetails WHERE appointmentID=$appointmentID";
       ...
       // $result->free();?>
        <div style="background-image: url('dogcat4.png')"><br>
            <fieldset style="margin-top: 2cm;margin-left: 11cm;margin-right: 11cm;background-color:white;padding-bottom: 0.2cm;">
                <form action="prescriptionedited.php?appointmentID=<?php echo $appointmentID ?>" method="POST" target="_self" enctype="multipart/form-data">
                   <br>
                    <h2 style="margin-left:10px">Edit Prescription</h2> 
                    <br>

                   
                    <textarea id="medicine" onkeyup="ValidateConcern();" style="text-transform:capitalize" name="medicine" size="30cm" rows="4" cols="60"  required><?php echo $medicine;?></textarea><br><br>
                    <textarea id="concern"  onkeyup="ValidateConcern();" name="prescription" size="30cm" rows="10" cols="60"  required><?php echo $prescription;?></textarea><br> 
