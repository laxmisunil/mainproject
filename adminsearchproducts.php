...
{
    $search=$_POST["search"];
$sel="SELECT * FROM tbl_productdetails WHERE productName LIKE '$search%' OR productName='$search'";
    ...
    if($result->num_rows>0)
    {
        ...
        ?>
                ...
                ?>
                    ...
                    <td style="text-align:center"><?php echo "Rs.".$row["productPrice"] ?></td>
                    ...
                    <td style="text-align:center"><a style="color:#D22B2B;text-align:center" title="Delete Product" href="removeproduct.php?productid=<?php echo $row["productID"]?>"><i class="fa fa-trash" aria-hidden="true"></a></i></td> 
