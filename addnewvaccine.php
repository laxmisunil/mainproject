...
{
    ?><div id="snackbar1">Vaccine already added!</div>
...
{
    ?><div id="snackbar2">Vaccine  added!</div>
...
function ValidateVaccineName() 
        {
            ...
            lblError3.innerHTML = "";
            var expr =  /^[a-zA-Z1-9 ]*$/;
            if (!expr.test(vaccinename)) 
            {
                lblError3.innerHTML = "Invalid Format";
        ...
        function ValidateAvailability() 
        {
            ...
            lblError7.innerHTML = "";
            var expr = /^[1-9]/;
            if (!expr.test(availability)) 
            {
                lblError7.innerHTML = "Invalid Format";
                const button = document.querySelector('#submitbutton');
                button.disabled = true;
                button.style.cursor="not-allowed";
            }
...
<div class="sidenav">
  ...
  <a style="color:chocolate" href="">Add new vaccine</a><br>
...
<section id="content" style="font-size:24px">
		...
		<nav>
			...
			<!--<form action="adminsearchproducts.php" method="POST">
				<div class="form-input">
					...
					<button style="background-color:#FBDE94" type="submit" class="search-btn"><i class='bx bx-search' style="color:black;margin-left:0.3cm" ></i></button>
				</div>
			</form>-->
		...
		<main>
			<div class="head-title">
                ...
                <form action="vaccineadded.php" method="POST" target="_self" enctype="multipart/form-data">
                   
                

                    <select name="pet" id="pet" required> 
                    <option value="" disabled selected hidden>--Select a Species--</option>
                        <option class="drop2">Dog</option>
                        <option class="drop2">Cat</option>
                       
                    </select>

                    <input type="text"  id="vaccinename" maxlength="30" size="30cm" onkeyup="ValidateVaccineName();" pattern="^[a-zA-Z1-9- ]*$" title="Must contain alphabets only" placeholder="Vaccine Name" name="vaccinename" required><br>
                    <span id="lblError3" style="color: red;font-size:small"></span>
                    <div id="uname_response" style="font-size:small;text-align:left"></div>
                    

        
                    <input type="number"  id="dose" min="1" max="3" size="30cm" onkeyup="ValidateDose();" pattern="^[1-5]*$" title="Must contain alphabets only" placeholder="No. of dose to be given per visit" name="dose" required><br>
                    <span id="lblError2" style="color: red;font-size:small"></span>



                    <select name="booster" id="pet" required> 
                    <option value="" disabled selected hidden>--Select booster type--</option>
                        <option value="6">Mid-year Booster</option>
                        <option value="1">Annual Booster</option>
                        <option value="2">Biennial Booster</option>
                        <option value="3">Triennial Booster</option>
                    ...
                    <input type="number"  id="availability" min="1" size="30cm" onkeyup="ValidateAvailability();" pattern="^[0-9]*$" title="Must contain digits only" placeholder="Vaccine Availability" name="availability" required><br>
                    <span id="lblError7" style="color: red;font-size:small"></span>

                    <!--<input type="text"  id="availability"  size="30cm"  maxlength="1" onkeyup="ValidateAvailability();" pattern="^[a-zA-Z- ]*$" title="Must contain Y/N only" placeholder="Vaccine Availability (Enter Y for YES N for NO)" name="availability"  required><br>
                    <span id="lblError9" style="color: red;font-size:small"></span>-->
                   
                    <textarea pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$"  rows="5" cols="60cm" maxlength="500" onkeyup="check()" id="comments" name="comments" placeholder="  Comments(Max. 300 characters)" required></textarea><br>
                    <div id="response2" style="font-size:small;text-align:center"></div>
                    <input type="submit" size="30cm" name="addvaccine" value="Add Vaccine" id="submitbutton">
