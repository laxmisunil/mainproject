    ...
    {?>
        <div style="background-image: url('dogcat4.png')"><br>
            <fieldset style="margin-top: 2cm;margin-left: 11cm;margin-right: 11cm;background-color:white;padding-bottom: 0.2cm;">
                <form action="vetupdation.php?vetID=<?php echo $vetid ?>" method="POST" target="_self" enctype="multipart/form-data">
                   <br>
                    <h2 style="margin-left:10px">My profile</h2> 
                    <br>

                    <input type="text"  id="vetname"  size="30cm" pattern="^[a-zA-Z ]*$" value="<?php echo $vetname ?>" name="vetname" title="Must contain alphabets only" placeholder="Name"required><br>
 
                    <input type="tel"  id="vetphone"  size="30cm" max=10 min=10 pattern="^[6-9]{1}[0-9]{9}" value="<?php echo $vetphone ?>"  placeholder="Mobile" name="vetphone" title="Digits are only allowed(Max 10 digits)" required><br>
                    <div style="display:flex">
                    <input type="text"  id="vethousename"  size="14m" pattern="^[a-zA-Z0-9 ]*$" title="Alphabets and digits are only allowed" value="<?php echo $vethousename ?>" placeholder="House Name/Apartment/Flat No." name="vethousename" required>&nbsp;
                    <input type="text"  id="vetpostoffice"  size="14cm" pattern="^[a-zA-Z ]*$" value="<?php echo $vetpostoffice ?>" placeholder="Post Office" title="Must contain alphabets only" name="vetpostoffice" required><br>
                    </div>

                    <div style="display:flex">
            
                    <input type="text"  id="vetdistrict"  size="30cm" pattern="^[a-zA-Z ]*$" value="<?php echo $vetdistrict ?>" title="Must contain alphabets only" name="vetdistrict" required><br>
                    </div>
                    
                    <input type="text"  id="vetpincode"  size="30cm" pattern="([6]{1}[0-9]{5}|[1-9]{1}[0-9]{3}[0-9]{3})" value="<?php echo $vetpincode ?>" maxlength=6 minlength=6 name="vetpincode" required><br>

                    
                    <input type="submit" value="Update" name="updatevet">
