<?php  
 ...
 {  
      ...
      $sql = "SELECT tbl1.*,tbl2.order_ID,sum(tbl2.productQuantity) AS totalQuantity,sum(tbl2.productOrderPrice) AS totalPrice FROM tbl_order AS tbl1 INNER JOIN tbl_orderitems AS tbl2 ON tbl1.orderID=tbl2.order_ID GROUP BY tbl1.orderDate HAVING tbl1.orderStatus!=0 ORDER BY tbl1.orderDate DESC";  
