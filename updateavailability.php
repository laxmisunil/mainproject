...
<script type="text/javascript">
        ...
        function ValidateAvailability() 
        {
            ...
            {
                lblError7.innerHTML = "Invalid Count";
...
if ($result2=$conn->query($vaccine))
{
    if($result2->num_rows>0)
    {
        while($row=$result2->fetch_array())
        {
            ...
            $availability=$row["vaccineAvailability"];
...
<section id="content" style="font-size:24px">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h2>Update Vaccine Availability</h2>
                    <fieldset style="margin-left: 6cm;margin-right: 11cm;background-color:white;padding: 10px;">
                <form action="vaccineavailabilityupdated.php?vaccineID=<?php echo $vaccineID?>" method="POST" target="_self" enctype="multipart/form-data">
                ...
                <input type="number"  id="availability" min="1" size="30cm" onkeyup="ValidateAvailability();" pattern="^[0-9]*$" title="Must contain digits only" placeholder="Add Dose" name="availability" required><br>
                    <span id="lblError7" style="color: red;font-size:small"></span>

                    <input type="submit" size="30cm" name="updatevaccineavailability" value="Update" id="submitbutton">
