        ...
        <table>
            ...
            if(isset($_POST["submit"]))
            {
               ...
               // $data="SELECT * FROM tbl_productdetails WHERE productName LIKE '$search%' OR productName='$search'";
                $sel="SELECT tbl2.*,tbl1.* FROM tbl_stock AS tbl2 INNER JOIN tbl_productdetails AS tbl1 ON tbl2.productID=tbl1.productID WHERE tbl1.productName LIKE '$search%' OR tbl1.productName='$search' GROUP BY tbl1.productID";
