<?php  
 ...
 {  
      ...
      $sql = "SELECT tbl1.*,tbl2.*,tbl3.* FROM tbl_pet  AS tbl1 INNER JOIN tbl_userdetails AS tbl2 ON tbl1.customerID=tbl2.userID INNER JOIN tbl_vaccinebooked AS tbl3 ON tbl1.petID=tbl3.petID WHERE tbl3.vaccinatedDate!='NULL' ORDER BY tbl1.petStatus DESC"; 
 ...
 {  
      ...
      <table border="1" cellspacing="0" cellpadding="5">  
           ...
           <th width="14%"><b>Vaccine</b></th> 
           <th width="15%"><b>Vaccinated On</b></th> 
      ...
      $obj_pdf->Output('vaccinationreport.pdf', 'I');  
 }  
 ?>  