...
<div class="sidenav">
  ...
  <a style="color:chocolate" href="">Vaccines</a><br>
...
{
	?><div id="snackbar1">Vaccine Added</div>
...
{
	?><div id="snackbar2">Vaccine Updated</div>
...
?>
<?php
$query4 = "select count(*) as totalvaccines from tbl_vaccinedetails";
...
<section id="content" style="font-size:24px">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h2>Vaccine List</h2>
					<button class="button-71" role="button-71" id="dogbutton"  onclick="dogvaccine();">Dog Vaccines</button>&nbsp;
					<button class="button-71" role="button-71" id="catbutton"   onclick="catvaccine();">Cat Vaccines</button>&nbsp;
					<ul class="breadcrumb">
			...
			<br>
			<form method="post" action="pdftodownload14.php">  
					<input type="submit" name="create_pdf" class="btn btn-danger" id="viewdata2" value="Download vaccine data" />  
				</form>
			...
			<div class="table-data"  id="dog">
				...
				<div class="form-input">
					<input type="search" class="live-search-box" name="search" id="search" placeholder="Search dog vaccines..." size="25cm">
					<input type="hidden" name="submit" style="background-color:transparent;border:transparent;color:transparent;padding:0.2px;margin:0px">
...
include "connection.php";
$date=date('Y-m-d');
$sel="SELECT * FROM tbl_vaccinedetails WHERE vaccineFor='Dog'";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
        ...
        ?>
                ...
                ?>
						<tbody>
							<tr>
								...
								<td><?php echo $row["vaccineAvailability"] ?>&nbsp;<a style="color:black;text-align:center" title="Update Availability" href="updateavailability.php?vaccineid=<?php echo $row["vaccineID"]?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                 <td>
                 
                 <form id="form" action="updatevaccineavailabilitydog.php?vaccineID=<?php echo $row["vaccineID"] ?>" method="POST">
                 <label class="switch" >
                 <button type="submit" name="togbutton" id="submitbutton" style='color:green'>   
                 <?php $vaccineStatus=$row["vaccineStatus"]; 
                 if($vaccineStatus==1)
                 ...
                 <td style="text-align:center"><a style="color:black;text-align:center" title="Update Vaccine" href="updatevaccine.php?vaccineid=<?php echo $row["vaccineID"]?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
			...
			<div class="table-data"  id="cat">
				<div class="order">
					<div class="head">
						<h3></h3>
						<form action="" method="POST">
				<div class="form-input">
					<input type="search" class="live-search-box2" name="search" id="search" placeholder="Search cat vaccines..." size="25cm">
					<input type="hidden" name="submit" style="background-color:transparent;border:transparent;color:transparent;padding:0.2px;margin:0px">
...
include "connection.php";
$date=date('Y-m-d');
$sel="SELECT * FROM tbl_vaccinedetails WHERE vaccineFor='Cat'";
if ($result=$conn->query($sel))
{
    if($result->num_rows>0)
    {
        ...
        ?>
                ...
                ?>
                 ...
                 <form id="form" action="updatevaccineavailability.php?vaccineID=<?php echo $row["vaccineID"] ?>" method="POST">
                 <label class="switch" >
                 <button type="submit" name="togbutton" id="submitbutton" style='color:green'>   
                 <?php $vaccineStatus=$row["vaccineStatus"]; 
                 if($vaccineStatus==1)
