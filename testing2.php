...
if ($result=$conn->query($username))
{
    ...
    {?>
        ...
        {
            echo "<br><br>";
            echo "<p style='color:red'>VACCINE CENTRE INACTIVE</p>";
            echo "<marquee id='inactivevet' scrollamount='10'>Please activate VACCINE CENTRE PROFILE to continue</marquee><br><br>";
            echo "<p>Click <a href='vaccinecentredetails.php'>here</a> to activate Vaccine Centre Profile</p>";
        }}?>
