...
?>
  ...
  <a href="veterinarydetails4.php" id="active">Veterinary Details</a><br>
...
if ($result=$conn->query($username))
{
    ...
    {?>
                ...
                <form action="vetupdation.php?vetID=<?php echo $vetid ?>" method="POST" target="_self" enctype="multipart/form-data">
                    ...
                    <input type="text"  id="proname" value="<?php echo $vetname ?>"size="30cm" onkeyup="ValidateProductName();" pattern="^[a-zA-Z ]*$" title="Must contain alphabets only" placeholder="Vet Name" name="proname" required><br>
        ...
        {
            echo "<br><br><table>";
            echo "<tr><td style='color:red'>VET INACTIVE</td></tr>";
            echo "<tr><td><marquee id='inactivevet' scrollamount='10'>Please activate VET PROFILE to continue</marquee></td></tr>";
            echo "<tr><td>Click <a href='veterinarydetails4.php' style='color:blue'>here</a> to activate Vet Profile</td></tr>";
            echo "</table>";
        }}?>
