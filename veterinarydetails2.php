...
<script>
    ...
    var checkboxvalue=document.getElementById("toggle");
    if(statusvalue==1)
    {
    ...
    <div id="d">
        ...
        <tr>
            ...
            <td><?php $userstatus=$row["userStatus"]; 
                    ...
                    echo "<p id='status'>INACTIVE</p>"
                    ?> 
            </td>
                 <td><form action="changevetstatus.php?userID=<?php echo $row["userID"] ?>" method="POST">
                    <!--<button type="submit" id="togbutton" onclick="check()" name="togbutton">-->
                    <label class="switch">
                    <input type="checkbox" id="toggle"  name="togbutton" onChange="this.form.submit()" >
