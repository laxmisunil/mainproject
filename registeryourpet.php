...
#showupcoming:hover,#showupcoming3:hover
{
  ...
  subjectSel.onchange = function() {
    ...
    <?php
       ...
       if((isset($_GET["status"]))==1)
        ...
        <button onclick="window.history.back();" id="showupcoming3" style="margin-left:0.6cm"><i class="fa fa-arrow-left" aria-hidden="true" style="color:white"></i></button>&nbsp;
        <center><fieldset style="width:50%;border:2px solid transparent;">
