...
#vaccinename:hover,#vaccinefor:hover
{
    cursor:not-allowed;
}
#showupcoming3
...
<script type="text/javascript">
        ...
        <?php
        $vaccine="SELECT * FROM tbl_vaccinedetails WHERE vaccineID='$vaccineID'";
if ($result2=$conn->query($vaccine))
{
    if($result2->num_rows>0)
    {
        while($row=$result2->fetch_array())
        {
            ...
            $vaccineFor=$row["vaccineFor"];
            $vaccineDose=$row["vaccineDose"];
            $boosterRecommendation=$row["boosterRecommendation"];
            $comments=$row["vaccineComments"];
...
<div class="sidenav">
  ...
  <a style="color:chocolate" href="vaccinelist.php">Vaccines</a><br>
...
<section id="content" style="font-size:24px">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h2>Update Vaccine Info</h2>
                    <fieldset style="margin-left: 6cm;margin-right: 11cm;background-color:white;padding: 10px;">
                <form action="vaccineupdated.php?vaccineID=<?php echo $vaccineID?>" method="POST" target="_self" enctype="multipart/form-data">
             
                <input type="text"  id="vaccinename" maxlength="15" size="30cm" value="<?php echo "$vaccineName"?>" pattern="^[a-zA-Z- ]*$" title="Must contain alphabets only" placeholder="Vaccine Name" name="vaccinename" readonly required><br>
                    <input type="text"  id="vaccinefor" maxlength="15" size="30cm"  value="<?php echo "$vaccineFor"?>" pattern="^[a-zA-Z- ]*$" title="Must contain alphabets only" placeholder="Vaccine For" name="vaccinefor" readonly required><br>
                    
                   
                    <font size="2px" color="grey">Dose per visit : </font><input type="text"  id="dose" maxlength="15" size="60cm" value="<?php echo $vaccineDose;?>" onkeyup="ValidateDose();" pattern="^[a-zA-Z1-3-, ]*$" title="Alphabets & digits only" placeholder="Vaccine Dose" name="dose" style="text-transform:capitalize" required><br>
                    ...
                    <input type="submit" size="30cm" name="addvaccine" value="Update" id="submitbutton">
