    ...
    <body style="background-color:white;">
        ...
        <div>  
            <fieldset style="margin-top: 1cm;margin-left: 11cm;margin-right: 11cm;background-color:white;padding-bottom: 0.2cm;">
                <form action="sendmail.php" method="POST" target="_self">
                <center><img src="logofinal.png" width="25%" >
                   
                    <h2 style="margin-left:10px">Reset Password</h2> <br>
                    <p>We'll email you instructions to reset the password</p><br>
                    
                    <input type="email" onkeyup="ValidateEmail();" placeholder="Email ID" name="email" id="email" required><br>
                    <span id="lblError" style="color: red;font-size:small"></span><br><br>
                    
                    <input type="submit" value="Send Link" name="resetpassword" id="submitbutton"><br><br>
